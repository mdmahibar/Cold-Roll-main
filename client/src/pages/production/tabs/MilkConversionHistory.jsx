...
const dummyHistory = [
  { id: 1, docketNo: 'DKT-MC-2023-001', date: '2023-10-25', note: 'Standardized morning batch', user: 'Admin' },
  { id: 2, docketNo: 'DKT-MC-2023-002', date: '2023-10-26', note: 'Cow milk to toned', user: 'Manager' },
  { id: 3, docketNo: 'DKT-MC-2023-003', date: '2023-10-27', note: 'Buffalo standardized', user: 'Admin' },
];

const MilkConversionHistory = () => {
  return (
            ...
            <tbody>
              {dummyHistory.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="border-b border-r border-slate-200 px-3 py-2 text-slate-600 truncate max-w-[300px]">
                    {item.note}
                  </td>
...
export default MilkConversionHistory;
