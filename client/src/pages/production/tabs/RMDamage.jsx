...
import RMDamageForm from './RMDamageForm';
import RMDamageTable from './RMDamageTable';
import RMDamageHistory from './RMDamageHistory';

const RMDamage = () => {
  // Top Form State
  const [docketNo, setDocketNo] = useState('DKT-RMD-2023-004');
      ...
      <div className="flex items-center justify-between rounded-sm border border-slate-200 bg-white p-4 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
        <div>
          <h2 className="text-sm font-bold tracking-tight text-slate-800 uppercase">
            Raw Materials Product Damaged Entry
          </h2>
        </div>
