...
const dummyHistory = [
  { id: 1, docketNo: 'DKT-FD-2023-001', date: '2023-10-25', netAmount: 1850.00, note: 'Bloated packets removed', user: 'Admin' },
  { id: 2, docketNo: 'DKT-FD-2023-002', date: '2023-10-26', netAmount: 420.50, note: 'Spoiled curd containers', user: 'Supervisor' },
  { id: 3, docketNo: 'DKT-FD-2023-003', date: '2023-10-27', netAmount: 625.00, note: 'Broken seal during loading', user: 'Admin' },
];

const FinishDamageHistory = () => {
  return (
    <div className="flex flex-col rounded-sm border border-slate-200 bg-white shadow-sm mt-8">
      <div className="border-b border-blue-100 bg-blue-50/50 px-4 py-3">
        <h3 className="text-xs font-bold uppercase tracking-wider text-blue-800">
          All Finish Product Damaged List
        </h3>
      </div>
...
export default FinishDamageHistory;
