...
const MaterialIssueTable = ({ items, onRemove }) => {
  // Calculate Totals
          ...
          <table className="w-full text-left text-[11px]">
              ...
              {items.length === 0 && (
                <tr>
                  <td colSpan="5" className="px-3 py-6 text-center text-slate-500">
                    No materials added. Please add products using the form above.
                  </td>
                </tr>
              )}
            </tbody>
            ...
            {items.length > 0 && (
              <tfoot className="bg-slate-100/50">
                <tr>
                  <td colSpan="3" className="border-t border-r border-slate-200 px-3 py-2 font-bold text-right text-slate-700">
                    Total Quantity
                  </td>
