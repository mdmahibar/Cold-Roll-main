...
const MixingDamageTable = ({ items, onUpdate, onRemove }) => {
  // Calculate Totals
    ...
    <div className="flex flex-col rounded-sm border border-slate-200 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
      <div className="border-b border-blue-100 bg-blue-50/50 px-4 py-3">
        <h3 className="text-xs font-bold uppercase tracking-wider text-blue-800">
          Damaged Mixing Product Entry List
        </h3>
      </div>
          ...
          <table className="w-full text-left text-[11px]">
            <thead className="bg-slate-50 text-slate-600">
              <tr>
                ...
                <th className="border-b border-r border-slate-200 px-3 py-2 font-bold uppercase text-right w-32">Rate (Edit)</th>
              ...
              {items.length === 0 && (
                <tr>
                  <td colSpan="7" className="px-3 py-6 text-center text-slate-500">
                    No damaged mixing products added.
                  </td>
                </tr>
              )}
            </tbody>
...
export default MixingDamageTable;
