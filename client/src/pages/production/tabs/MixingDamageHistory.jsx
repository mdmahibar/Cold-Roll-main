...
const dummyHistory = [
  { id: 1, docketNo: 'DKT-MD-2023-001', date: '2023-10-25', netAmount: 2450.00, note: 'Curd mix tank contamination', user: 'Admin' },
  { id: 2, docketNo: 'DKT-MD-2023-002', date: '2023-10-26', netAmount: 820.50, note: 'Temperature control failure', user: 'Supervisor' },
  { id: 3, docketNo: 'DKT-MD-2023-003', date: '2023-10-27', netAmount: 125.00, note: 'Line leak during transfer', user: 'Admin' },
];

const MixingDamageHistory = () => {
  return (
          ...
          <table className="w-full text-left text-[11px]">
            ...
            <tbody>
              {dummyHistory.map((item) => (
                <tr key={item.id} className="hover:slate-50/50 transition-colors">
...
export default MixingDamageHistory;
