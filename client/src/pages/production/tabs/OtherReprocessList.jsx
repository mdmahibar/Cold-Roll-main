...
const dummyHistory = [
  { id: 1, docketNo: 'DKT-OR-2023-001', date: '2023-10-25', note: 'Re-processed damaged SMP', user: 'Admin' },
  { id: 2, docketNo: 'DKT-OR-2023-002', date: '2023-10-26', note: 'Butter melt back routine', user: 'Manager' },
  { id: 3, docketNo: 'DKT-OR-2023-003', date: '2023-10-27', note: 'Cream purification loop', user: 'Admin' },
];

const OtherReprocessList = () => {
  return (
            ...
            <tbody>
              {dummyHistory.map((item) => (
                <tr key={item.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="border-b border-r border-slate-200 px-3 py-2 text-slate-600 truncate max-w-[200px]">
                    {item.note}
                  </td>
...
export default OtherReprocessList;
