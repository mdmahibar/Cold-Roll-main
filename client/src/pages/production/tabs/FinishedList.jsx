...
const dummyHistory = [
  { id: 1, docketNo: 'DKT-2023-11001', date: '2023-10-25', note: 'Standard pasteurization batch', user: 'Admin' },
  { id: 2, docketNo: 'DKT-2023-11002', date: '2023-10-26', note: 'Morning fat standardization', user: 'Manager' },
  { id: 3, docketNo: 'DKT-2023-11003', date: '2023-10-27', note: 'Evening shift butter extraction', user: 'Admin' },
];
    ...
    <div className="flex flex-col rounded-sm border border-slate-200 bg-white shadow-sm mt-8">
      <div className="border-b border-blue-100 bg-blue-50/50 px-4 py-3">
        <h3 className="text-xs font-bold uppercase tracking-wider text-blue-800">
          All Milk Finish Product Creation List
        </h3>
      </div>
