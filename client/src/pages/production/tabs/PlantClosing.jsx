...
import PlantClosingForm from './PlantClosingForm';
import PlantClosingTable from './PlantClosingTable';
import PlantClosingHistory from './PlantClosingHistory';

const PlantClosing = () => {
  // Top Form State
  const [docketNo, setDocketNo] = useState('DKT-PC-2023-004');
  ...
  const handleSave = () => {
    console.log('Saved Plant Closing Entry:', items);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Entry Component */}
      <PlantClosingForm onAdd={handleAdd} />
