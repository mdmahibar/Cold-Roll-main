...
const dummyHistory = [
  { id: 1, docketNo: 'DKT-PC-2023-001', date: '2023-10-25', note: 'Night shift closing', user: 'Admin' },
  { id: 2, docketNo: 'DKT-PC-2023-002', date: '2023-10-26', note: 'Maintenance halt', user: 'Supervisor' },
  { id: 3, docketNo: 'DKT-PC-2023-003', date: '2023-10-27', note: 'End of month tally', user: 'Admin' },
];

const PlantClosingHistory = () => {
  return (
...
export default PlantClosingHistory;
