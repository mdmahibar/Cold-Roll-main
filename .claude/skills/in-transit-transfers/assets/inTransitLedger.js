...
export const fields = {
    ...
    destination: (doc) => text(doc?.U_DESTNATIONSIS), // who the stock is FOR
    base: (doc) => text(doc?.U_SISBASE), // which dispatch a receipt settles
    kind: (doc) => text(doc?.U_SISTYPE).toUpperCase(), // 'D' dispatch | 'R' receipt
